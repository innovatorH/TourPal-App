...
const FrameComponent1 = ({
  ...
  const defaultAvatar202042jpgStyle = useMemo(() => {
    return {
  ...
  return (
    <div
      className={`self-stretch flex flex-row items-start justify-center py-0 pl-5 pr-[21px] box-border max-w-full mt-[-32px] text-left text-base-5 text-wwwtripadvisorcom-black font-wwwtripadvisorcom-inter-black-463 ${className}`}
    >
      <div className="w-[1232px] rounded-sm bg-white flex flex-row items-start justify-between pt-6 pb-3 pl-6 pr-[25px] box-border shrink-0 max-w-full gap-5 z-[1] mq1050:flex-wrap mq1050:justify-center">
        <div className="w-[511.9px] flex flex-row items-start justify-start gap-[15px] max-w-full mq750:flex-wrap">
          <div className="h-[126px] w-[126px] rounded-107xl bg-white overflow-hidden shrink-0 flex flex-row items-start justify-start relative">
            <div
              className="h-[120px] w-[calc(100%_-_6px)] absolute !m-[0] top-[calc(50%_-_60px)] right-[3px] left-[3px] rounded-101xl overflow-hidden bg-[url('/defaultavatar202042jpg@3x.png')] bg-cover bg-no-repeat bg-[top] z-[2]"
              style={defaultAvatar202042jpgStyle}
            >
              <img
        ...
        <div className="h-[34px] flex flex-row items-start justify-start gap-[0.8px]">
          <button className="cursor-pointer [border:none] pt-[7.8px] pb-[8.2px] pl-4 pr-[15px] bg-white h-[35.6px] rounded-tl-10xs rounded-tr-none rounded-br-none rounded-bl-10xs border-gainsboro-200 border-t-[0.8px] border-solid border-gainsboro-200 border-b-[0.8px] border-solid border-gainsboro-200 border-l-[0.8px] border-solid box-border flex flex-row items-start justify-start shrink-0 whitespace-nowrap hover:bg-gainsboro-100">
            <a
              className="relative text-smi-9 leading-[18px] font-bold font-wwwtripadvisorcom-inter-black-463 text-wwwtripadvisorcom-black text-center inline-block [text-decoration:none] min-w-[69px]"
...
FrameComponent1.propTypes = {
  ...
  editProfileHref: PropTypes.string.isRequired,
  editProfileTarget: PropTypes.string,
