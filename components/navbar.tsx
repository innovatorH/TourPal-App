...
const Navbar = ({ className = "" }) => {
  ...
  return (
    <header
      className={`self-stretch flex flex-row items-start justify-center pt-6 pb-[25.8px] pl-[132px] pr-5 sticky gap-[67px] top-[0] z-[99] text-left text-3xl-6 text-gray-600 font-open-sans lg:gap-[33px] lg:pl-[66px] lg:box-border mq750:gap-[17px] mq750:pl-[33px] mq750:box-border ${className}`}
    >
