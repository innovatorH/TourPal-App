...
import DivSection from "../components/div-section";
...
const SignUp = () => {
  ...
  return (
    <div className="w-full relative [background:linear-gradient(46.33deg,_rgba(33,_33,_33,_0.84),_rgba(66,_66,_66,_0.24))] overflow-hidden flex flex-row items-start justify-start pt-[132px] px-[185px] pb-0 box-border gap-[63.5px] leading-[normal] tracking-[normal] z-[1] text-left text-20xl-1 text-white font-zen-kaku-gothic-antique mq450:pl-5 mq450:pr-5 mq450:box-border mq800:gap-4 mq800:pl-[46px] mq800:pr-[46px] mq800:box-border mq1300:gap-8 mq1300:flex-wrap mq1300:pl-[92px] mq1300:pr-[92px] mq1300:box-border">
      <img
        className="h-[2160px] w-[3840px] absolute !m-[0] top-[-892px] right-[-2333px] object-cover z-[1]"
        alt=""
        src="/ultra-hd-4k-landscape-12776871-1@2x.png"
      />
      <img
      ...
      <div className="w-[481px] flex flex-col items-start justify-start pt-[134px] px-0 pb-0 box-border min-w-[481px] max-w-full mq1125:min-w-full mq800:pt-[87px] mq800:box-border mq1300:flex-1">
        <div className="self-stretch flex flex-col items-start justify-start gap-12 max-w-full mq800:gap-6">
          <div className="self-stretch flex flex-col items-start justify-start gap-[94px] max-w-full mq800:gap-[47px]">
